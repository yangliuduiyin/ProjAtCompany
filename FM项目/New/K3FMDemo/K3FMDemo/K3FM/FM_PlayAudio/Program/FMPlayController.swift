...
class FMPlayController: UIViewController {
    ...
    private lazy var collectionView : UICollectionView = {
        ...
        // MARK -注册头视图和尾视图
        collection.register(FMPlayHeaderView.self, forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: FMPlayHeaderViewID)
        collection.register(FMPlayFooterView.self, forSupplementaryViewOfKind: UICollectionView.elementKindSectionFooter, withReuseIdentifier: FMPlayFooterViewID)
        // MARK -注册不同分区cell
    ...
    // MARK: - ViewModel
    lazy var viewModel = FMPlayViewModel(albumId:albumId,trackUid:trackUid, uid:uid)
    ...
    // MARK: - 当前选中Cell对应的音频播放器
    fileprivate weak var currentAudioPlayer: STKAudioPlayer?
...
extension FMPlayController : UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if indexPath.section == 0 {
            ...
            currentAudioPlayer = cell.audioPlayer // self持有cell的audioPlayer.
            return cell
...
//        self.dismiss(animated: true, completion: nil)
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        if kind == UICollectionView.elementKindSectionHeader {
            let headerView : FMPlayHeaderView = collectionView.dequeueReusableSupplementaryView(ofKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: FMPlayHeaderViewID, for: indexPath) as! FMPlayHeaderView
            return headerView
        }else if kind == UICollectionView.elementKindSectionFooter {
            let footerView : FMPlayFooterView = collectionView.dequeueReusableSupplementaryView(ofKind: UICollectionView.elementKindSectionFooter, withReuseIdentifier: FMPlayFooterViewID, for: indexPath) as! FMPlayFooterView
            return footerView
        }
...
extension FMPlayController: UICollectionViewDelegateFlowLayout {
    //每个分区的内边距
