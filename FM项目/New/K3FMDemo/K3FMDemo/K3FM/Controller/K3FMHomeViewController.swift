...
class K3FMHomeViewController: UIViewController {
    ...
    private lazy var Keywords = [ClassifySubMenuKeywords]()
...
//        }
    ...
    fileprivate func initHeaderView(){
        ...
        let pageView = DNSPageView(frame: CGRect(x: 0, y: 0, width: .YYScreenWidth, height: .YYScreenHeigth - .navigationBarHeight), style: style, titles: nameArray as! [String], childViewControllers: viewControllers)
